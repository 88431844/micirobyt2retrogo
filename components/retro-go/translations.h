...
static const char *translations[][RG_LANG_MAX] =
{
    ...
    },
    {
        [RG_LANG_EN] = "Solid",
        [RG_LANG_FR] = "Fixe",
        [RG_LANG_DE] = "Dauerlicht",
        [RG_LANG_ZH_CN] = "常亮",
    },
    {
        [RG_LANG_EN] = "Breathe",
        [RG_LANG_FR] = "Respiration",
        [RG_LANG_DE] = "Atmen",
        [RG_LANG_ZH_CN] = "呼吸灯",
    },
    {
    ...
    {
        [RG_LANG_EN] = "Fast blink",
        [RG_LANG_FR] = "Clignotement rapide",
        [RG_LANG_DE] = "Schnelles Blinken",
        [RG_LANG_ZH_CN] = "快闪烁",
    },
    {
        [RG_LANG_EN] = "Heartbeat",
        [RG_LANG_FR] = "Battement",
        [RG_LANG_DE] = "Herzschlag",
        [RG_LANG_ZH_CN] = "双脉冲",
    },
    {
        [RG_LANG_EN] = "Low battery sound",
        [RG_LANG_FR] = "Son de batterie faible",
        [RG_LANG_DE] = "Ton bei schwacher Batterie",
        [RG_LANG_ZH_CN] = "低电量声音",
    },
    {
        [RG_LANG_EN] = "Once",
    ...
    {
        [RG_LANG_EN] = "Battery calibration",
        [RG_LANG_FR] = "Calibration batterie",
        [RG_LANG_DE] = "Batteriekalibrierung",
        [RG_LANG_ZH_CN] = "电池校准",
    },
    {
        [RG_LANG_EN] = "Current voltage",
        [RG_LANG_FR] = "Tension actuelle",
        [RG_LANG_DE] = "Aktuelle Spannung",
        [RG_LANG_ZH_CN] = "当前电压",
    },
    {
        [RG_LANG_EN] = "Calibrated 0% voltage",
        [RG_LANG_FR] = "Tension calibrée à zéro pour cent",
        [RG_LANG_DE] = "Kalibrierte 0%-Spannung",
        [RG_LANG_ZH_CN] = "已校准的 0% 电压",
    },
    {
        [RG_LANG_EN] = "Calibrated 100% voltage",
        [RG_LANG_FR] = "Tension calibrée à cent pour cent",
        [RG_LANG_DE] = "Kalibrierte 100%-Spannung",
        [RG_LANG_ZH_CN] = "已校准的 100% 电压",
    },
    {
        [RG_LANG_EN] = "Set 0% voltage",
        [RG_LANG_FR] = "Tension à zéro pour cent",
        [RG_LANG_DE] = "Spannung bei 0%",
        [RG_LANG_ZH_CN] = "设置 0% 电压",
    },
    {
        [RG_LANG_EN] = "Set 100% voltage",
        [RG_LANG_FR] = "Tension à cent pour cent",
        [RG_LANG_DE] = "Spannung bei 100%",
        [RG_LANG_ZH_CN] = "设置 100% 电压",
    },
    {
        [RG_LANG_EN] = "Restore default calibration",
        [RG_LANG_FR] = "Rétablir le calibrage par défaut",
        [RG_LANG_DE] = "Standardkalibrierung wiederherstellen",
        [RG_LANG_ZH_CN] = "恢复默认校准",
    },
    {
        [RG_LANG_EN] = "Restore default calibration?",
        [RG_LANG_FR] = "Rétablir le calibrage par défaut ?",
    ...
    {
        [RG_LANG_EN] = "Default calibration restored.",
        [RG_LANG_FR] = "Calibrage par défaut rétabli.",
        [RG_LANG_DE] = "Standardkalibrierung wiederhergestellt.",
        [RG_LANG_ZH_CN] = "已恢复默认校准。",
    },
    {
        [RG_LANG_EN] = "Set 0% voltage to current reading?",
        [RG_LANG_FR] = "Définir la tension zéro pour cent sur la valeur actuelle ?",
        [RG_LANG_DE] = "0%-Spannung auf aktuellen Wert setzen?",
        [RG_LANG_ZH_CN] = "将当前读数设为 0% 电压？",
    },
    {
        [RG_LANG_EN] = "Set 100% voltage to current reading?",
        [RG_LANG_FR] = "Définir la tension cent pour cent sur la valeur actuelle ?",
        [RG_LANG_DE] = "100%-Spannung auf aktuellen Wert setzen?",
        [RG_LANG_ZH_CN] = "将当前读数设为 100% 电压？",
    },
    {
        [RG_LANG_EN] = "0% voltage must be below 100% voltage.",
        [RG_LANG_FR] = "La tension zéro pour cent doit être inférieure à la tension cent pour cent.",
        [RG_LANG_DE] = "Die 0%-Spannung muss unter der 100%-Spannung liegen.",
        [RG_LANG_ZH_CN] = "0% 电压必须低于 100% 电压。",
    },
    {
        [RG_LANG_EN] = "100% voltage must be above 0% voltage.",
        [RG_LANG_FR] = "La tension cent pour cent doit être supérieure à la tension zéro pour cent.",
        [RG_LANG_DE] = "Die 100%-Spannung muss über der 0%-Spannung liegen.",
        [RG_LANG_ZH_CN] = "100% 电压必须高于 0% 电压。",
    },
    {
        [RG_LANG_EN] = "Battery not available.",
        [RG_LANG_FR] = "Batterie indisponible.",
        [RG_LANG_DE] = "Batterie nicht verfügbar.",
        [RG_LANG_ZH_CN] = "未检测到电池。",
    },
    {
        [RG_LANG_EN] = "Battery critically low, saving...",
        [RG_LANG_FR] = "Batterie très faible, sauvegarde...",
        [RG_LANG_DE] = "Batterie fast leer, speichere...",
        [RG_LANG_ZH_CN] = "电量严重不足，正在保存...",
    },
    {
        [RG_LANG_EN] = "%.3fV",
        [RG_LANG_FR] = "%.3fV",
